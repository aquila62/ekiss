/* ekisspwr.c - ekiss random number generator Version 1.0.0          */
...
/* See ekissint.c for generating a random signed integer   */

#include "ekiss.h"

unsigned int ekisspwr(kissfmt *kk, int bits)
   {
   unsigned int intgr;      /* output UINT */
   intgr = ekiss(kk) >> (32-bits);
